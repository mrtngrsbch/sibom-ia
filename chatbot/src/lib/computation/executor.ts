...
import type { ComputationResult, AggregationResult, RowFilter } from './table-engine';
...
function formatRowAsMarkdown(table: StructuredTable, row: Record<string, string | number | null>): string {
...
function extractFiltersFromQuery(query: string, tables: StructuredTable[]): RowFilter[] {
