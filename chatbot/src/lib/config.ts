...
export const APP_CONFIG = {
  ...
  /** Descripción breve */
  description: 'Observatorio independiente de la decepción municipal',

  /** Bajada institucional (para contextos formales) */
  descriptionFormal: 'Observatorio independiente de legislación municipal bonaerense',
