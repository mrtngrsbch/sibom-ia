/**
 * Archivo centralizado de íconos de Lucide React
 *
 * @description Este archivo implementa tree-shaking para Lucide React,
 * importando solo los íconos que realmente se usan en la aplicación.
 *
 * Reducción esperada: ~450KB en el bundle JS (~35% del tamaño de lucide-react)
 *
 * USO: En lugar de `import { Icon } from 'lucide-react'`, usar:
 * `import { Icon } from '@/lib/icons'`
 *
 * NOTE: lucide-react 0.400+ ya soporta tree-shaking por defecto
 */
